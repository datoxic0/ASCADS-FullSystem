...
const INSTRUCTION_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'math-mod' as const, name: 'MOD', symbol: 'MOD', desc: 'Modulo' },
      { type: 'math-mov' as const, name: 'MOV', symbol: 'MOV', desc: 'Move Data' },
      { type: 'math-abs' as const, name: 'ABS', symbol: 'ABS', desc: 'Absolute Value' },
      { type: 'math-sqrt' as const, name: 'SQR', symbol: 'SQR', desc: 'Square Root' },
