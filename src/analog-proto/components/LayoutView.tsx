...
export default function LayoutView({ design, onUpdateComponent }: LayoutViewProps) {
  ...
  return (
    <div ref={containerRef} className="flex-1 bg-slate-950 flex flex-col relative overflow-hidden font-sans">
      ...
      {/* Main Canvas Area */}
      <div className={`flex-1 flex items-center justify-center transition-all duration-700 overflow-auto ${
        ...
        <motion.div 
           ...
           className={`relative bg-slate-900 border-[12px] border-slate-800 rounded-3xl shadow-[0_50px_100px_rgba(0,0,0,0.6)] ${
